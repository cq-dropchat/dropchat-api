...
// Ratchet (end of phase 4): reached − 2, rounded down. Reached: _shared
// 74.4 %, handlers 54.3 %, all 57.6 %. Never lowered.
// (Phase 3: 66 / 29 / 35.)
const DEFAULT_MIN_SHARED = 72;
const DEFAULT_MIN_HANDLERS = 52;
const DEFAULT_MIN_LINES = 55;
